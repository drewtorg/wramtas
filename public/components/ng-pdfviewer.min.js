/*
 ...
 MIT license
*/
angular.module("PDFViewer",[]).directive("pdfviewer",["$parse",function(){var d=null,e=null;return{restrict:"E",template:"<canvas></canvas>",scope:{onPageLoad:"&",loadProgress:"&",src:"@",id:"="},controller:["$scope",function(a){a.pageNum=1;a.pdfDoc=null;a.scale=1;a.documentProgress=function(c){a.loadProgress&&a.loadProgress({state:"loading",loaded:c.loaded,total:c.total})};a.loadPDF=function(c){console.log("loadPDF ",c);PDFJS.getDocument(c,null,null,a.documentProgress).then(function(b){a.pdfDoc=
